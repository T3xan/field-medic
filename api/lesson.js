...
// Your ANTHROPIC_API_KEY lives in Vercel environment variables, never in the browser
...
export default async function handler(req, res) {
  ...
  try {
    ...
    res.setHeader('Cache-Control', 's-maxage=3600, stale-while-revalidate'); // cache lessons for 1hr
